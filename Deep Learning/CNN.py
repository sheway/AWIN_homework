...
for folder in os.listdir(train_data_path):
    ...
    print(' numbers of images in folder are : ', len(files))  #抓取該資料夾中所有照片
...
X_train, data, y_train, datalabel= train_test_split(X_train, y_train, test_size=0.00231642, random_state=2)
